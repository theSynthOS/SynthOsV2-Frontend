        ...
        {balance !== null && balance > 0 ? (
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">APY: 3.2%</div>
                </div>
              </div>
              <div className="text-right">
                <div className="font-medium">${balance.toFixed(2)}</div>
                <div className="text-sm text-gray-500">0.05 ETH</div>
              </div>
            </div>
          </div>
        ) : (
          <div className="flex flex-col items-center justify-center py-6 text-center">
            <div className="text-gray-400 mb-3">
              ...
              <p className="text-sm text-gray-500 mb-6">Start by depositing assets to earn yields</p>
              <button 
                onClick={() => setShowModal("deposit")}
