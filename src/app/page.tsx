...
export default function Home() {
  ...
  const renderContent = () => {
    ...
    if ((onboardingStep === "wallet-analysis" || onboardingStep === "preferences") && 
        !isAuthenticated) {
  ...
  const renderPreferences = () => {
    const currentProfile = profile || { title: "New to DeFi", description: "You're just getting started with DeFi. We'll help you navigate the ecosystem safely." }
    ...
    return (
      ...
      >
        ...
        <div className={`p-4 rounded-lg mb-4 ${theme === 'dark' ? 'bg-purple-900/20 text-white' : 'bg-purple-100 text-black'}`}>
          <p className="mb-2 text-lg font-bold">You are <span className="text-purple-400">{currentProfile.title}</span></p>
