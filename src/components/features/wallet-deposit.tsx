  ...
  return (
    <div className="fixed inset-0 z-50" onClick={handleClose}>
      ...
      >
        ...
        {/* Modal Content - Scrollable Area - Removed touch-none for better mobile scrolling */}
        <div 
          className="px-4 pb-safe overflow-y-auto flex-grow overscroll-contain"
          style={{ 
              ...
              <div className={`${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-50'} rounded-lg p-${isMobile ? '4' : '6'}`}>
                ...
                <div className="flex justify-center mb-3">
                  {address ? (
                    ...
                    <div className={`w-[${isMobile ? '150px' : '180px'}] h-[${isMobile ? '150px' : '180px'}] ${theme === 'dark' ? 'bg-gray-600' : 'bg-gray-200'} rounded-lg flex items-center justify-center`}>
